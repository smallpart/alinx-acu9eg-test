...
HD_PWD='D:/atom/program/mwsystems/test/acu9eg_ad9173/alinx_test/alinx_test.runs/system_util_ds_buf_sysref_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_util_ds_buf_sysref_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_util_ds_buf_sysref_0.tcl
