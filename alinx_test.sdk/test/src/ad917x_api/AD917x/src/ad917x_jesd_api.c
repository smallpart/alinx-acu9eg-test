...
static int jesd_get_link_count(ad917x_handle_t *h, uint8_t *link_count) {
	int err;
	uint8_t tmp_reg;
...
static int jesd_set_link(ad917x_handle_t *h, int link) {
	int err;
	uint8_t tmp_reg;
...
ADI_API int ad917x_jesd_get_link_status(ad917x_handle_t *h, jesd_link_t link,
