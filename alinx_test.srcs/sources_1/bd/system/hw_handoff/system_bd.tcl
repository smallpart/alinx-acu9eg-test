...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_dac_control, and set properties
  set axi_gpio_dac_control [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_dac_control ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {3} \
 ] $axi_gpio_dac_control
  ...
  set modulator_0 [ create_bd_cell -type ip -vlnv mig-trading.ru:atom:modulator:1.0 modulator_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_dac_txen_GPIO [get_bd_intf_ports dac_txen] [get_bd_intf_pins axi_gpio_dac_control/GPIO]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_gpio_dac_control/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80007000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs modulator_0/S00_AXI/S00_AXI_reg] SEG_modulator_0_S00_AXI_reg
