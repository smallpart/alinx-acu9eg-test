...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_util_ds_buf_sysref_0 -prefix
--               system_util_ds_buf_sysref_0_ system_util_ds_buf_2_0_sim_netlist.vhdl
...
entity system_util_ds_buf_sysref_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of system_util_ds_buf_sysref_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of system_util_ds_buf_sysref_0_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of system_util_ds_buf_sysref_0_util_ds_buf : entity is 1;
end system_util_ds_buf_sysref_0_util_ds_buf;

architecture STRUCTURE of system_util_ds_buf_sysref_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_util_ds_buf_sysref_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of system_util_ds_buf_sysref_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_util_ds_buf_sysref_0 : entity is "system_util_ds_buf_2_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_util_ds_buf_sysref_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_util_ds_buf_sysref_0 : entity is "util_ds_buf,Vivado 2019.1.3";
end system_util_ds_buf_sysref_0;

architecture STRUCTURE of system_util_ds_buf_sysref_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_util_ds_buf_2_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.system_util_ds_buf_sysref_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
